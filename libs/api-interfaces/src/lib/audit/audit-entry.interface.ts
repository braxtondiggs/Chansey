...
export enum AuditEventType {
  ...
  REGIME_GATE_SKIPPED = 'REGIME_GATE_SKIPPED',
  ...
  // Failed job DLQ events
  FAILED_JOB_RECORDED = 'FAILED_JOB_RECORDED',
  FAILED_JOB_REVIEWED = 'FAILED_JOB_REVIEWED',
  FAILED_JOB_RETRIED = 'FAILED_JOB_RETRIED',
  FAILED_JOB_SPIKE_DETECTED = 'FAILED_JOB_SPIKE_DETECTED'
}
