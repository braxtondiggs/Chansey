 ...
 *
 * Endpoints:
 * - GET /deployments/:id/performance - Get performance summary
 * - GET /deployments/:id/performance/metrics - Get performance time series
 * - GET /deployments/:id/performance/comparison - Compare to backtest
 * - GET /deployments/:id/drift - Get drift alerts and summary
 * - GET /deployments/:id/drift/active - Get active drift alerts only
 */
@ApiTags('Monitoring')
