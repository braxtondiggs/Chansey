...
export class ConvertUserIdToUuid1738100000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Also drop manually-named constraint from CreatePaperTradingTables migration
    await queryRunner.query(
      `ALTER TABLE "paper_trading_sessions" DROP CONSTRAINT IF EXISTS "fk_paper_trading_sessions_user"`
    );
    ...
    // Also drop manually-named constraint from CreatePositionExitsTable migration
    await queryRunner.query(`ALTER TABLE "position_exits" DROP CONSTRAINT IF EXISTS "FK_position_exits_user"`);
    await queryRunner.query(
