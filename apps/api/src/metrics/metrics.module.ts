...
// ===================
// Infra Metric Providers
// ===================

const INFRA_METRIC_PROVIDERS = [
  makeHistogramProvider({
...
// ===================
// Trading Metric Providers
// ===================

const TRADING_METRIC_PROVIDERS = [
  makeCounterProvider({
  ...
  makeCounterProvider({
    name: 'chansey_concentration_gate_blocks_total',
    help: 'Total entry signals blocked by the concentration limit gate'
  }),
  makeCounterProvider({
...
// ===================
// Strategy Metric Providers
// ===================

const STRATEGY_METRIC_PROVIDERS = [
  makeGaugeProvider({
...
// ===================
// Backtest Metric Providers
// ===================

const BACKTEST_METRIC_PROVIDERS = [
  makeCounterProvider({
...
@Module({
  ...
  providers: [
    ...INFRA_METRIC_PROVIDERS,
    ...TRADING_METRIC_PROVIDERS,
    ...STRATEGY_METRIC_PROVIDERS,
    ...BACKTEST_METRIC_PROVIDERS,
