...
import { ExchangeKeyHealthSummary } from '@chansey/api-interfaces';

import { ExchangeService } from '../../services/exchange.service';

const CRITICAL_CATEGORIES = new Set(['authentication', 'permission']);
...
export class ExchangeStatusAlertComponent {
  ...
  readonly degradedExchanges = computed<ExchangeKeyHealthSummary[]>(() => {
    ...
    return data.filter((k) => k.healthStatus !== 'healthy' && !unhealthyIds.has(k.id));
  });
